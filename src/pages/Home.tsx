      ...
      <Container className="mb-2" maxWidth="lg">
        <Grid container spacing={4}>
          {!highlightsError && (
            <>
              <Grid item xs={12} md={4}>
                <CardComponent
                  className={
                    highlightsLoading ? 'skeleton-loading skeleton-loading-mh-1' : ''
                  }
                >
              ...
              <Grid item xs={12} md={4}>
                ...
                >
                  {!highlightsLoading && highlightsData && (
                    <>
                      <StyledH2 color="white" className="mb-1">
                        Meta do mês
                      </StyledH2>
                      <StyledH3 color="white" size={40} className="mb-1">
          ...
          <Grid item xs={12} md={5}>
            {!starsError && (
              <CardComponent
                className={starsLoading ? 'skeleton-loading skeleton-loading-mh-2' : ''}
              >
                {!starsLoading && starsData && (
                  <>
                    <StyledH2 className="mb-1">Maiores vendedores no mês</StyledH2>
                    <AvatarList
                      listData={starsData.map((star) => ({
